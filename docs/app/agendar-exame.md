...
3. Escolha o **profissional** (quando houver mais de uma opção).
...
3. Toque em **Cancelar** ou **Remarcar** e confirme.

:::note
Prazos de cancelamento/remarcação podem variar conforme a política da unidade de saúde.
:::

## Acompanhando o dia do exame

No dia do atendimento, acompanhe sua posição na fila em tempo real — veja [Fila em tempo real](./fila-tempo-real.md).
